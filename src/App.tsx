              ...
              <div className="relative py-20 px-4 overflow-hidden bg-neutral-950 text-white border-b border-amber-400/25">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
                  ...
                  <p className="text-sm md:text-base text-zinc-300 max-w-2xl mx-auto leading-relaxed">
                    Wakaaladda Socdaalka iyo Dalxiiska ee <strong className="text-amber-400 font-extrabold text-amber-500">Balcad Travel Agency</strong> waxay kuugu adeegaysaa Tikidhada Diyaaradaha, Diyaarinta Hoteelada, Adeega Fiisooyinka, iyo Dalxiiska gudihiisa iyo dibadiisaba.
                  </p>
                  ...
                  <div className="pt-4 flex flex-wrap gap-4 justify-center">
                    <button
                      ...
                      className="px-8 py-3.5 bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-zinc-950 font-black text-xs rounded-full shadow-lg active:scale-95 transition-all text-center leading-none uppercase tracking-wider cursor-pointer"
                    >
                      Eeg Adeegyada
                    </button>
                    <button
                      ...
                      className="px-8 py-3.5 bg-zinc-950 border border-zinc-700 hover:bg-zinc-800 text-white font-bold text-xs rounded-full active:scale-95 transition-all leading-none uppercase tracking-wider cursor-pointer"
                    >
