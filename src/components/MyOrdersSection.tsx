    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="space-y-6">
        {activeSearch && orders.length === 0 && (
          <div className="text-center py-12 px-6 rounded-3xl border border-dashed border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/20 max-w-md mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-zinc-100 dark:border-zinc-800 pb-4 mb-4">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-zinc-100 dark:bg-zinc-800 rounded-2xl">
            ...
            >
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  type="button"
                  onClick={() => setCancelingOrderId(null)}
                  className="flex-1 bg-zinc-100 dark:bg-zinc-800 text-zinc-850 dark:text-zinc-200 text-xs font-black py-2.5 rounded-xl transition-all border border-zinc-200 dark:border-zinc-700"
                >
                  Maya (No)
                </button>
              </div>
