        ...
        {!activeAdmin ? (
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <span className="text-[10px] text-zinc-400 uppercase tracking-widest block mt-2 font-bold select-none leading-none">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  type="submit"
                  className="w-full bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 text-zinc-950 hover:from-amber-500 hover:to-amber-600 font-extrabold text-xs py-3.5 rounded-xl shadow-md active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            <div className="p-4 rounded-3xl bg-neutral-950 text-white flex flex-col md:flex-row gap-4 items-center justify-between border border-zinc-800">
              ...
              <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 bg-zinc-800 hover:bg-zinc-750 text-zinc-300 hover:text-white text-xs font-bold rounded-xl transition-all active:scale-95 cursor-pointer"
                >
                              ...
                              <div className="space-y-2 flex-grow">
                                ...
                                <div className="space-y-1 text-xs">
                                  <p className="text-zinc-900 dark:text-zinc-100 font-bold">
                                    👤 Macmiilka: <span className="font-extrabold text-amber-600 dark:text-amber-450">{ord.data.fullName}</span>
                                  </p>
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1 mt-2 p-2.5 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 text-zinc-605">
                              ...
                              <div className="flex flex-col sm:items-end justify-between h-full gap-4 shrink-0 mt-3 md:mt-0 md:min-w-[170px] self-stretch">
                                ...
                                <div className="text-right">
                                  {ord.status === 'processing' && (
                                    <span className="inline-flex items-center gap-1 px-2.5 py-1 text-[10px] font-black bg-amber-100 text-amber-800 dark:bg-amber-950/20 dark:text-amber-400 rounded-full border border-amber-300/20">
                                ...
                                {activeAdmin?.role === 'super' && (
                                  <div className="flex gap-2 justify-end items-center mt-auto w-full">
                                    <button
                                      ...
                                      className="p-1 px-1.5 bg-zinc-50 hover:bg-red-50 dark:bg-zinc-950/40 text-zinc-400 hover:text-red-600 border border-zinc-200/50 hover:border-red-300/20 rounded-lg transition-all cursor-pointer"
                                      title="Tirtir"
                                    >
                        ...
                        {chatsList.length === 0 ? (
                          ...
                          chatsList.map((chat) => (
                            ...
                            >
                              ...
                              <span className="text-[9px] text-zinc-400 truncate block leading-none">{chat.userEmail}</span>
                        ...
                        {currentOpenChat ? (
                          <div className="flex flex-col h-full justify-between relative">
                              ...
                              {!currentOpenChat.assignedAdminId ? (
                                <>
                                  ...
                                  <button
                                    ...
                                    className="px-2.5 py-1 bg-amber-400 hover:bg-amber-500 text-zinc-950 font-black rounded-lg transition-all shadow-sm shrink-0 uppercase tracking-wide cursor-pointer text-[9px]"
                                  >
                            ...
                            >
                              ...
                              <button
                                type="submit"
                                className="px-3 py-2 bg-gradient-to-r from-amber-400 to-yellow-500 rounded-xl font-bold shadow-md hover:shadow-lg active:scale-95 transition-all outline-none cursor-pointer"
                              >
                            ...
                            {isAssignedToOther && (
                              <div className="absolute inset-0 z-30 bg-zinc-950/80 dark:bg-zinc-950/95 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center select-none">
                                ...
                                <button
                                  type="button"
                                  onClick={() => setActiveChatId(null)}
                                  className="mt-6 px-6 py-2.5 bg-gradient-to-r from-amber-400 to-yellow-400 hover:scale-105 active:scale-95 text-zinc-955 rounded-xl font-black text-xs uppercase tracking-wider transition-all shadow-md cursor-pointer"
                                >
                                  ← Ku laabo liiska
                                </button>
                              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                      <form onSubmit={handleCreateAd} className="space-y-4">
                        ...
                        <button
                          ...
                          type="submit"
                          className="w-full bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 text-zinc-950 font-extrabold text-xs py-3.5 rounded-xl hover:shadow-lg active:scale-95 transition-all outline-none cursor-pointer"
                        >
                          Dhig Ad-ka cusub
                        </button>
                      </form>
                            ...
                            <div key={ad.id} className="p-3 bg-white dark:bg-zinc-905 border border-zinc-100 dark:border-zinc-800 rounded-xl flex justify-between items-start gap-2">
                              <div className="flex gap-3">
                                <img
                                  src={ad.image}
                                  alt={ad.title}
                                  className="w-16 h-16 object-cover rounded-lg border border-zinc-100 dark:border-zinc-800 shrink-0"
                                  referrerPolicy="no-referrer"
                                />
                                <div>
                                  <h5 className="font-bold text-xs text-zinc-900 dark:text-zinc-100 leading-tight">{ad.title}</h5>
                                  <p className="text-[10px] text-zinc-400 mt-1 line-clamp-2">{ad.description}</p>
                                </div>
                              </div>
                              <button
                                type="button"
                                onClick={() => handleDeleteAd(ad.id, ad.title)}
                                className="p-2 text-zinc-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-955/20 rounded-xl transition-all cursor-pointer shrink-0"
                  ...
                  <div className="space-y-6">
                    ...
                    {activeAdmin.role !== 'super' ? (
                      <div className="p-6 text-center border border-red-300/20 bg-red-50/50 dark:bg-red-955/15 rounded-3xl text-red-600">
                        <ShieldAlert className="w-10 h-10 text-red-550 mx-auto mb-3" />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        <form onSubmit={handleRegisterAdmin} className="space-y-4">
                          <p className="text-xs font-black uppercase tracking-wider text-amber-505 text-amber-500">
                          ...
                          <button
                            ...
                            type="submit"
                            className="w-full bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 text-zinc-950 font-extrabold text-xs py-3 rounded-xl hover:shadow-lg active:scale-95 transition-all text-center cursor-pointer"
                          >
            ...
            >
              ...
              <div className="flex gap-3 mt-6">
                <button
                  ...
                  className="flex-1 bg-red-500 hover:bg-red-655 text-white text-xs font-bold py-2.5 rounded-xl transition-all cursor-pointer"
                >
                  Haa
                </button>
                <button
        ...
        {viewingResolverOrder && (
          <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="mt-4 text-xs space-y-2 text-left bg-zinc-50 dark:bg-zinc-950/45 p-3.5 border border-zinc-150 dark:border-zinc-800 rounded-2xl">
                <div>
                  <span className="text-zinc-400 block font-bold text-[10px] uppercase">Magaca Shaqaalaha:</span>
                ...
                <div>
                  <span className="text-zinc-400 block font-bold text-[10px] uppercase">Taleefan:</span>
                ...
                <div>
                  <span className="text-zinc-400 block font-bold text-[10px] uppercase">Email:</span>
