...
const DEFAULT_ADMINS: AdminUser[] = [
  {
    id: 'super-1',
    fullName: 'Hussein Mohamud Ali (super admin)',
    phone: '0615501050',
      ...
      messages: [
        {
          id: 'welcome',
          sender: 'assistant',
          text: `Asc Soodhawow macamiil ${userName}! Anaga waxaan ahay kaaliyaha rasmiga ah ee Balcad Travel Agency. Waxaan diyaar kuugu nahay inaan kaa caawino dhammaan su'aalaha ku saabsan tikidhada, huteelada, iyo fiisada. Sideen kuugu caawin karnaa maanta?`,
          createdAt: new Date().toISOString()
        }
      ],
      createdAt: new Date().toISOString()
